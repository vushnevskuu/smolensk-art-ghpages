...
Статический сайт сообщества: публичная лента, админка приглашённых авторов,
медиа и фон «Солнечный день». Фронтенд публикуется на **GitHub Pages**,
...
Админка: `/admin/`. Если Appwrite временно недоступен, публичная страница
показывает сохранённую копию из `src/data/content-ru.json`.
